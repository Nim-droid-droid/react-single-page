...
<div className='grid md:grid-cols-2 max-w-[1240px] h-[600px] m-auto'>
    ...
    <div className='flex flex-col justify-center  ml-20 text-[#506473] w-full px-8 py-8 md:items-start'>
        <p className='text-[#C0345E]'>BRAND, DEV, ECOM, MARKETING</p>
        <div className=' text-5xl font-light w-full py-8'>
                  <h5 className=' text-5xl text-[#19293A]'>We unleash</h5>
    ...
    <div className='w-[640px] h-[640px] -mt-20 ml-56 '>
        <img src={Dog} alt="/" />
    </div>
